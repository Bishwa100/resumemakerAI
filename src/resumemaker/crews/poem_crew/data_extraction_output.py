...
class CandidateProfile(BaseModel):
    ...
    linkedin_url: Optional[str] = Field(None, description="Candidate's LinkedIn profile URL.")
    github_url: Optional[str] = Field(None, description="Candidate's GitHub profile URL.")
